...
class StringUtils {
    ...
    {
        return str_replace('-','',substr(String_utils::uuid(),1,-1));
    }
    ...
    public static function randString($len=6,$type='',$addChars='')
    {
        ...
        switch($type) {
            ...
            case 4:
                ...
                break;
            case 5:
                $chars='abcdefghijklmnopqrstuvwxyz23456789'.$addChars;
                break;
            default :
    ...
    public static function buildFormatRand($format,$number=1)
    {
        ...
        for($j=0; $j<$number; $j++) {
            ...
            for($i=0; $i<$length; $i++) {
                ...
                switch($char){
                    case "*"://字母和数字混合
                        $strtemp   .= String_utils::randString(1);
                        break;
                    case "#"://数字
                        $strtemp  .= String_utils::randString(1,1);
                        break;
                    case "$"://大写字母
                        $strtemp .=  String_utils::randString(1,2);
                        break;
                    default://其他格式均不转换
                        $strtemp .=   $char;
                        break;
